pipeline {
    ...
    environment {
        ...
        ANSIBLE_DIRECTORY = 'Lesson_15_Jenkins_pipelines_NodeJS_Apps/project_setup_files/ansible'
    ...
    stages {
        ...
        stage('Run Ansible for the apps and load balancer') {
            steps {
                withCredentials([sshUserPrivateKey(credentialsId: 'connect-me-to-aws', keyFileVariable: 'SSH_KEY')]) {
